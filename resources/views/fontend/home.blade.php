...
@section('content')
                ...
                <div class="col-md-9 col-sm-8">
                        ...
                        <div class="col-md-10 col-sm-10">
                            <div class="lead-news">
                                <div class="service-img"><a href="#"><img
                                            src="{{ asset('fontend') }}/assets/img/news.jpg" width="800px"
                                            alt="Notebook"></a></div>
                                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3">
                            <div class="top-news">
                                <a href="#"><img src="{{ asset('fontend') }}/assets/img/news.jpg" alt="Notebook"></a>
    ...
    <section class="news-section">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="add"><img src="{{ asset('fontend') }}/assets/img/top-ad.jpg" alt="" /></div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="add"><img src="{{ asset('fontend') }}/assets/img/top-ad.jpg" alt="" /></div>
                </div>
            ...
            <div class="row">
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="sidebar-add">
                                <img src="{{ asset('fontend') }}/assets/img/top-ad.jpg" alt="" />
                            </div>
                        </div>
                    </div><!-- /.add-close -->
                        ...
                        <div class="col-md-8 col-sm-8">
                            <div class="photo_screen">
                                <div class="myPhotos" style="width:100%">
                                    <img src="{{ asset('fontend') }}/assets/img/news.jpg" alt="Avatar">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div class="photo_list_bg">
                                ...
                                <div class="photo_img photo_border active">
                                    <img src="{{ asset('fontend') }}/assets/img/news.jpg" alt="image" onclick="currentDiv(1)">
