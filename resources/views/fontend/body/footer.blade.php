        ...
        <div class="top-footer">
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="foot-logo">
                        <img src="{{ asset('fontend') }}/assets/img/demofooter.png" style="height: 50px;" />
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="apps-img">
                        <ul>
                            <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/apps-01.png"
                                        alt="" /></a></li>
                            <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/apps-02.png"
                                        alt="" /></a></li>
                        </ul>
                    </div>
                </div>
